...
def main(api_key_path, audio_input_path):
	load_dotenv()
	api_key_from_file,audio_url = api_key_and_audio_input(api_key_path, audio_input_path)
	elevenlabs = ElevenLabs(api_key=api_key_from_file,)
...
if __name__ == "__main__":
	transcription = ''
	# transcription = main('api_key.txt', 'audio_input.txt')
	file_name = "1st-A3"
	transcription = saveload_transcription(transcription, f"transcription_results_{file_name}.pkl")

	word_to_json(transcription,f'transcription_results_{file_name}.json')
